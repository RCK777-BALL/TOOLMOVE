...
export function WeldsPage({ userId }: WeldsPageProps) {
    ...
    <div className="space-y-4">
      ...
      {showAddForm && (
        <div className="bg-white rounded-lg shadow p-4">
          <AddWeldForm onSuccess={handleAdded} onCancel={() => setShowAddForm(false)} />
        </div>
      )}

      <WeldList userId={userId} refresh={refreshKey} />
    </div>
  );
}
